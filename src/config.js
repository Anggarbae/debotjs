...
const whichPlatform = platform() === 'doniganteng' ? 'CROMEOS' : 'CROMEOS';

const config = {
  LINE_DOMAIN_INDO: 'ga.line.naver.jp',
  LINE_DOMAIN_FAST: 'ga.line.naver.jp',
  LINE_DOMAIN_TOOFAST: 'ga.line.naver.jp',
  LINE_DOMAIN: 'ga.line.naver.jp',
  LINE_DOMAIN_2ND: 'ga.line.naver.jp',
  LINE_DOMAIN_3RD: 'ga.line.naver.jp',
  ...
  LINE_HTTP_URL_2ND: '/api/v4/TalkService.do',
  LINE_HTTP_URL_3ND: '/api/v4/TalkService.do',
  LINE_RS: '/api/v4p/rs',
  ...
  LINE_POST_CONTENT_URL: 'https://ga.line.naver.jp/talk/m/upload.nhn',
  LINE_POST_CONTENT_URL_2ND: 'https://obs-sg.line-apps.com/talk/m/upload.nhn',
  X_LINE_APP: 'CHROMEOS\t2.1.5\tDonnigans_OS\t1',
  ip: '127.0.0.1',
  version: '0.0.2',
  revision: 0,
  hostname: hostname(),
