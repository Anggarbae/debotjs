...
class LineAPI {
  ...
  setTHttpClient(options = {
    ...
    options.headers['X-Line-Application'] = 'CHROMEOS\t2.1.5\tDefrizal_OS\t1';
  ...
  _qrCodeLogin() {
    ...
    this._client.getAuthQrcode(true, 'OLENG BOT PC',(err, result) => {
      const qrcodeUrl = `line://au/q/${result.verifier}`;
      qrcode.generate(qrcodeUrl,{small: true});
      console.info(`\n\nClick login: ${qrcodeUrl}`)
